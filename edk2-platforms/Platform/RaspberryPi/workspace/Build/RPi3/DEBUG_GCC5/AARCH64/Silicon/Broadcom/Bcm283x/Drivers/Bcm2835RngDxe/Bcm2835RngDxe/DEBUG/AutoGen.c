...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9743084e, 0xc82a, 0x4714, {0xb2, 0xba, 0xf5, 0x71, 0xf8, 0x1c, 0xb0, 0x21}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Bcm2835RngDxe";
...
{
  return Bcm2835RngEntryPoint (ImageHandle, SystemTable);
}
