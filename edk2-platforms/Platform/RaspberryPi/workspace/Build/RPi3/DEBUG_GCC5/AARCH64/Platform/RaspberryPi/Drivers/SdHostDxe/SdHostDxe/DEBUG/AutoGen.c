...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x58ABD787, 0xF64D, 0x4CA2, {0xA0, 0x34, 0xB9, 0xAC, 0x2D, 0x5A, 0xD0, 0xCF}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SdHost";
...
{
  return SdHostInitialize (ImageHandle, SystemTable);
}
