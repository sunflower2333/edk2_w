...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3944f2d7, 0x2e09, 0x4fc0, {0x9e, 0x98, 0x00, 0x83, 0x75, 0x64, 0x14, 0x53}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "InterruptDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdInterruptBaseAddress = _PCD_VALUE_PcdInterruptBaseAddress;
