...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdFirmwareVendor[5] = {69, 68, 75, 50, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdFirmwareVendor = 10;
...
#define _PCD_TOKEN_PcdDefaultTerminalType  155U
